...
def main(fconfig):
    ...
    working_directory = fconfig['obs']['romsobs']['LEO']['WORKING_DIRECTORY']
    prefix = fconfig['obs']['romsobs']['LEO']['WORKING_DIRECTORY']
    prefix = fconfig['obs']['romsobs']['LEO']['prefix']
