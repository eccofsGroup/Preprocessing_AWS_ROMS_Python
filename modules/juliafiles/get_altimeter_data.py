...
def get_altimeter_data(grd, alt_dir, start_day):
    ...
    return data
#-------------------------------------------------------------------------
def get_all_altimetry(grd, start_day):

    # --- Get observations
    # ————————————————
    # 1) DEFINE YOUR PATHS
    # ————————————————
    jas3_dir        = "/p/om/cron/ECCOFS_OBS/SSH/data/raw/jason3/"
    sentinel3a_dir  = "/p/om/cron/ECCOFS_OBS/SSH/data/raw/sentinel3a/"
    sentinel3b_dir  = "/p/om/cron/ECCOFS_OBS/SSH/data/raw/sentinel3b/"
    sentinel6a_dir  = "/p/om/cron/ECCOFS_OBS/SSH/data/raw/sentinel6a/"
    ...
    np.savez_compressed('altimeter_data.npz', **altimeter_data)
