...
# def get_cfrf():
def main(fconfig):
    # input_dir = f"{vol}/om/cron/ECCOFS_OBS/CFRF/data/processed/ECCOFS_INSITU_CFRF_"
    # grd_file = f"{vol}/julia/ROMS/eccofs/Data/grid_eccofs_6km_08_b7.nc"
    # std_dir = f"{vol}/julia/ROMS/eccofs/Data/STD_eccofs6km_20112023_run01_1_1_wMLD1TS/eccofs6km_std_mesoscale_20112023_"

    input_dir = fconfig['obs']['romsobs']['CFRF']['input_dir']
    grd_file =fconfig['obs']['romsobs']['gridfile']
    std_dir = fconfig['obs']['romsobs']['CFRF']['std_dir']
    working_directory =fconfig['obs']['romsobs']['CFRF']['WORKING_DIRECTORY']
    prefix = fconfig['obs']['romsobs']['CFRF']['prefix']
 ...
 #   output_file = 'OBS_FILES/cfrf_nrt_';

 #   working_directory = f"{vol}/julia/ROMS/eccofs/OBS_python/CFRF/OBS_FILES"
  #  prefix = 'cfrf_nrt_'
    ...
    for day in days:
        ...
        B['obs_label'] = 732 * np.ones(len(B['obs_value']))
        ...
        if survey > 0:
           ...
           ds.history = "CFRF near real time data transformed into 4DVAR format"
           ...
           addhistory = (
           "Observations of temperature and salinity, downloaded from CFRF"   
