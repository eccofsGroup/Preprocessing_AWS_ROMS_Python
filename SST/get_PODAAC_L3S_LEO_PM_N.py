...
outdirec='/home/ubuntu/PODAAC/L3S_LEO_PM_N/'
...
filepart='-ECCOFS-L3S_GHRSST-SST-LEO_PM_N-ACSPO_V2.81-v02.0-fv01.0.nc'
fathon_bucket_name= "fathom-eccofs"
folder = "data/sst/L3S_LEO_PM_N/"
...
def main():
    ...
    for dt in date_times:
        ...
        search_url=s3_url+sdate+'*LEO_PM_N*.nc'
