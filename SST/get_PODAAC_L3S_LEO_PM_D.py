...
outdirec='/home/ubuntu/PODAAC/L3S_LEO_PM_D/'
...
s3_url='s3://podaac-ops-cumulus-protected/L3S_LEO_PM-STAR-v2.81/'
s3 = s3fs.S3FileSystem(anon=False)
encoding = {'sst_dtime': {'units': 'milliseconds'}}
filepart='-ECCOFS-L3S_GHRSST-SST-LEO_PM_D-ACSPO_V2.81-v02.0-fv01.0.nc'
fathon_bucket_name= "fathom-eccofs"
folder = "data/sst/L3S_LEO_PM_D/"
...
def main():
    ...
    for dt in date_times:
        ...
        search_url=s3_url+sdate+'*LEO_PM_D*.nc'
